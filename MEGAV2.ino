...
const String Pompes[] = {"Pompe 1   ", "Pompe 2   ", "Pompe 3   ", "Pompe 4   ", "Pompe 5   ", "Pompe 6   ", "Pompe 7   ", "Pompe 8   ", "Pompe 9   ", "Pompe 10  ", "Pompe 11  ", "Pompe 12  ", "Pompe 13  ", "Pompe 14  ", "Pompe 15  ", "Pompe 16  ", "Pompe 17  ", "Pompe 18  ", "Pompe 19  ", "Pompe 20  ", "RETOUR             "}; // Affichage du menu pour la distribution
//const String Pompes[] = {"Pompe 1 ", "Pompe 2 "}; // Affichage du menu pour la distribution
const int nombreDePompes = 20; // Constante du nombre de pompe pour le modulo
...
void setup() {
  ...
  pinMode(41, OUTPUT); // Déclaration des pins de pompe comme sortie pour la board relais
  ...
  pinMode(49, OUTPUT); // Déclaration des pins de pompe comme sortie pour la board relais
  pinMode(51, OUTPUT); // Déclaration des pins de pompe comme sortie pour la board relais
  pinMode(53, OUTPUT); // Déclaration des pins de pompe comme sortie pour la board relais
    ...
    case 6: // Sous menu pour la purge unitaire des pompes.
     ...
     if (etatBout2) { // Si le bouton 2 (BAS) est appuyé
      ...
      do // On lance une boucle qui ne s'arrêtera qu'à la fin du chargement.
      {
       ...
       draw_progressbar(avancement);
       pompeV2(lapompe,3); //  Si la Pompe est activée, alors on regarde si elle a pu délivrer x Cl ( x CL = X * 6000 millisecondes). Si c'est le cas, alors on coupe la pompe, sinon on laisse allumer.
       //Serial.println((millis() - temps));
